...
public class CreateSetOfDupelsDemo {
	...
	public static void main(String[] args) {
		...
		Comparator<Dupel<String, String>> cmp = new Comparator<Dupel<String, String>>() {
		...
		Set<String> set1 = new HashSet<>(Arrays.asList(mystrings1));
		Set<String> set2 = new HashSet<>(Arrays.asList(mystrings2));
